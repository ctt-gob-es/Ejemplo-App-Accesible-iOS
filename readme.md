...
[ejemplo_android]: https://github.com/ctt-gob-es/Ejemplo-App-Accesible-Android

# ToDo Manager

 Esta aplicación para iOS es un ejemplo del uso de la [GUÍA DE ACCESIBILIDAD DE APLICACIONES MÓVILES (APPS)][guia]
